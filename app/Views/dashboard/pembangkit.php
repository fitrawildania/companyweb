...
<head>
    ...
    <title>Pembangkit Dashboard</title>
...
<body id="page-top">
    ...
    <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Pembangkit:</h6>
                        <a class="collapse-item" href="aset">EAM Asset Properti</a>
                        <a class="collapse-item" href="siipp">SIIPP</a>
                        <a class="collapse-item" href="gas">GBMO GAS</a>
                        <a class="collapse-item" href="bbm">GBMO BBM</a>
                        <a class="collapse-item" href="bbo">BBO</a>
                        <a class="collapse-item" href="maximo">EAM-KIT</a>
                        <a class="collapse-item" href="mapp">MAPP POWER</a>
                    </div>
                </div>
            </li>
</ul>
    ...
    <?php endif; ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2>Pembangkit Dashboard</h1>
                        <a href="<?php echo site_url('generate-pdf') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
